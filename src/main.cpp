...
unsigned int nStakeMaxAge = 90 * 24 * 60 * 60; // Vertex - 90 days
unsigned int nModifierInterval = 10 * 60; // Vertex - time to elapse before new modifier is computed
...
const string strMessageMagic = "Vertex Signed Message:\n";
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "Vertex", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "VERTEX - Bitcoin Block #362067";
        CTransaction txNew;
        txNew.nTime = 1434993705;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1434993705;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = !fTestNet ? 813120 : 813120;
...
// <- GEN
        ...
        assert(block.hashMerkleRoot == uint256("0x8e17c4a32d055ed732ccde3ff4df5a29f49e6259ad3696b5af4cd3148168533f"));
